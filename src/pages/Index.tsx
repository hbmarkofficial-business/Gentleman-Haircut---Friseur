  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Bremen | Gentleman Haircut</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Gentleman Haircut in Bremen für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Gentleman Haircut | Premium Barbershop Bremen" />
        <meta
        ...
        <meta name="twitter:title" content="Gentleman Haircut | Premium Barbershop Bremen" />
        <meta
